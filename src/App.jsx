  ...
  return (
    <div className="wrapper">
      ...
      <form>
        ...
        <div>
          <input onChange={handleChange} required type="password" name="charOne" maxLength="1" value={userInput.charOne}/>

          <input onChange={handleChange} required type="password" name="charTwo" maxLength="1" value={userInput.charTwo}/>

          <input onChange={handleChange} required type="password" name="charThree" maxLength="1" value={userInput.charThree} />

          <input onChange={handleChange} required type="password" name="charFour" maxLength="1" value={userInput.charFour}/>
        </div>

        <button onClick={handleSubmit} disabled={verified}>Gönder</button>
      </form>
